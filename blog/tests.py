...
class TestView(TestCase):
    def setUp(self):
        #user 정보
        self.client = Client()#client 사용하겠다
        self.user_gyu = User.objects.create_user(username='규',password='somepassword')
        self.user_obama = User.objects.create_user(username = 'obama', password='somepassword')
        self.user_gyu.is_staff = True
        self.user_gyu.save()
    ...
    def navbar_test(self, soup):
        ...
        logo_btn = navbar.find('a', text='KangDa')
    ...
    def test_post_list(self):
        ...
        self.assertIn(self.user_gyu.username.upper(), main_area.text)
    ...
    def test_post_detail(self):
        ...
        self.assertIn(self.user_gyu.username.upper(), post_area.text)
    ...
    def test_create_post(self):
        ...
        #staff가 아닌 obama가 로그인을 한다.
        self.client.login(username='obama', password='somepassword')
        response = self.client.get('/blog/create_post/')
        self.assertNotEqual(response.status_code, 200)

        #staff인 규로 로그인한다.
        self.client.login(username='규', password='somepassword')
    ...
    def test_update_post(self):
        ...
        #로그인은 했지만 작성자가 아닌 경우
        self.assertNotEqual(self.post_003.author, self.user_obama)
        self.client.login(
    ...
    def test_comment_update(self):
        comment_by_gyu = Comment.objects.create(
            post=self.post_001,
            author=self.user_gyu,
            content='규의 댓글입니다'
        )
    ...
    def test_delete_comment(self):
        ...
        self.assertFlase(comment_area.find('a', id='comment-2-delete-btn'))
        ...
        self.assertIn(self.post_001.title, soup.title.text)
        comment_area = soup.find('div', id='comment-area')
        self.assertNotIn('규의 댓글입니다.', comment_area.text)
